...
# define CREATE_FUNCTION(type, name) type PRE_FUNC_NAME##name(CREATE_ARGS)

# define CREATE_FUNCTION_PARAMS(type, name, params) \
	type PRE_FUNC_NAME##name(CREATE_ARGS, params)

# define CREATE_MAIN(type, name) type name(const int argc, \
